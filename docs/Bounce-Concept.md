...
If they converge, the result is validated. Not because any single model is trusted, but because independent convergence is the strongest signal we have.

If they diverge, we see who said what, where they agreed, and where they split. It is a mechanism for truth.
